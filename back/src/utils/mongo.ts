...
import { Artisulo, Historial, Salida } from "./models/artisulo";
...
export function getSalidasCollection(): Collection<Salida> {
  return getDatabase().collection<Salida>("Salidas");
}
